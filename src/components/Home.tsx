...
const Home = () => {
  ...
  return (
    <motion.section
      ...
      className="flex flex-col items-center h-[98vh] pt-[25vh] w-[100vw] dark:bg-[#1d1d1f] duration-200"
    >
      ...
      <motion.button
        ...
        className="xs:py-3 xs:px-5 bg-blue-600 text-white font-bold rounded-full flex gap-2
